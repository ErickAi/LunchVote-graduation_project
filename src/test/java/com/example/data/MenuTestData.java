...
public class MenuTestData {
    ...
    public static final int PAST_NOT_VOTED_MENU_ID = 1000;
    public static final int CURRENT_VOTE_EXIST_MENU_ID = 1001;
    public static final int CURRENT_NOT_VOTED_MENU_ID = 1002;
    public static final int FUTURE_NOT_VOTED_MENU_ID = 1003;
    public static final int FUTURE_FOR_UPDATE_MENU_ID = 1004;
    public static final int FUTURE_EXAMPLE_MENU_ID = 1005;
    ...
    public static final Menu CURRENT_VOTE_EXIST_MENU = new Menu(CURRENT_VOTE_EXIST_MENU_ID,
            LocalDate.now(), RESTAURANT_1, Arrays.asList(DISH_04, DISH_05, DISH_06));
    public static final Menu CURRENT_NOT_VOTED_MENU = new Menu(CURRENT_NOT_VOTED_MENU_ID,
            LocalDate.now(), RESTAURANT_2, Arrays.asList(DISH_07, DISH_08, DISH_09));

    public static final Menu FUTURE_NOT_VOTED_MENU = new Menu(FUTURE_NOT_VOTED_MENU_ID,
            LocalDate.now().plusDays(1), RESTAURANT_1, Arrays.asList(DISH_10, DISH_11, DISH_12));
    public static final Menu FUTURE_FOR_UPDATE_MENU = new Menu(FUTURE_FOR_UPDATE_MENU_ID,
            LocalDate.now().plusDays(1), RESTAURANT_2, Arrays.asList(DISH_13, DISH_14, DISH_15));

    public static final Menu FUTURE_EXAMPLE_MENU = new Menu(FUTURE_EXAMPLE_MENU_ID,
            LocalDate.of(2018,12,31), RESTAURANT_1, null);
